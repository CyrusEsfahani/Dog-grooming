        ...
        <div className="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:max-w-none lg:grid lg:grid-cols-2 lg:gap-x-16 lg:divide-y-0">
          <div>
            ...
            <p className="mt-4 leading-7 text-gray-600">
              Have questions about our services? We're here to help! Fill out the form below, and we'll get
            ...
            <div className="mt-10 space-y-4 text-base leading-7 text-gray-600">
              <div className="flex gap-x-4">
                ...
                <dd>123 Grooming Street<br />Pet City, PC 12345</dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                ...
                <dd><a href="tel:(555) 123-4567" className="hover:text-primary-600">(555) 123-4567</a></dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                ...
                <dd><a href="mailto:info@pawperfect.com" className="hover:text-primary-600">info@pawperfect.com</a></dd>
              </div>
            </div>
          </div>
